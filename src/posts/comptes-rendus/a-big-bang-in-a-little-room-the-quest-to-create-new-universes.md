...
reviews:
  ...
  - # Identité du critique
    author: "Nom du critique"          # optionnel
    author_url: "https://..."          # optionnel - lien vers le profil/site du critique
    author_role: "Philosophe, CNRS"    # optionnel - titre ou affiliation

    # Identification de la critique
    title: "Titre de la critique"      # optionnel
    source: "Revue de Métaphysique"    # optionnel - publication ou support
    source_url: "https://..."          # optionnel - lien vers la critique originale

    # Évaluation
    rating: 4.5                        # optionnel - valeur numérique (ex: sur 5)
    rating_max: 5                      # optionnel - valeur maximale (défaut implicite : 5)
    sentiment: "positive"              # optionnel - positive | neutre | negative | mitigée

    # Contenu
    excerpt: "Citation courte mise en avant"   # optionnel - accroche affichée en avant
    content: "Texte complet de la critique"    # optionnel - corps détaillé

    # Métadonnées éditoriales
    lang: "fr"                         # optionnel - langue de la critique (ISO 639-1)
    featured: true                     # optionnel - mise en avant dans le template
    verified: false                    # optionnel - critique vérifiée/authentifiée

  - author: "Autre critique"
    title: "Titre alternatif"
    source: "Le Monde des Livres"
    date: 2025-11-10
    rating: 3.8
    sentiment: "mitigée"
    excerpt: "Un ouvrage stimulant malgré quelques réserves."
    content: "Autre avis développé ici."
    featured: false
---
